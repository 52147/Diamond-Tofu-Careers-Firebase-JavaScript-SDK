        ...
        >
          ...
          <Modal.Body>
            <p>
              ...
              subsidiaries and affiliates https://www.(“we”, “Diamond Tofu”)
              ...
              In certain jurisdictions, our recruitment
              process may include data analytics and algorithms to help us to
              efficiently review the large quantities of candidates and
              application data that we receive. When you submit a job
              application, the information you share with us will be screened
              and compared to the predefined responses and scores set for the
              relevant roles. You may also undergo a series of online
              assessments. We may collect data generated by your participation
              in psychological, technical or behavioural assessments. The
              predefined responses are based on data that indicates what good
              job performance at Diamond Tofu looks like and/or in relation to
              these assessments. You will receive more information about the
              nature of such assessments before your participation in any of
              them. These results are always considered in tandem with, and not
              in lieu of, human judgement and evaluation of individual
              candidates. <br /><br />
              ...
              DO WE TRANSFER YOUR PERSONAL INFORMATION ACROSS GEOGRAPHIES?  <br />
              Because Diamond Tofu is an organization we need to transfer personal information across
              geographical borders to Diamond Tofu entities, our service
              providers or business partners in other countries working on our
              behalf in accordance with Applicable Data Privacy Laws. Our
              affiliates and third parties may be based in different countries
              around the world, including outside of the EEA and the UK. Diamond
              Tofu maintains and stores personal information in systems and
              applications located in Europe and the United States, and the
              personal information is only accessible by authorized persons or
              vendors who are bound by privacy requirements. Personal
              information may be processed at various locations where Diamond
              Tofu conducts business, including in the United States and other
              countries[4]. Examples of countries we transfer personal
              information to include, but are not limited to, Germany, the
              Netherlands, the United States of America, Singapore, and India.
              We only make these arrangements or transfers where we are
              satisfied that adequate levels of protection are in place to
              protect information held in that country. <br /><br />
              HOW DO WE PROTECT YOUR INFORMATION?<br />
              Diamond Tofu has in place appropriate technological
              and operational security processes designed to protect your
              personal information from loss, misuse, alteration or destruction.
              Only authorized employees and providers will have access to any
              data provided by you, and that access is limited by need. Each
              employee or provider having access to any personal information is
              obligated to maintain its confidentiality. Although we take steps
              that are generally accepted as industry standard to protect your
              personal information, Diamond Tofu cannot guarantee that your
              personally identifiable information will not become accessible to
              unauthorized persons. <br /><br />
              ...
              requests: 1. You may request that we disclose to you the following
              ...
              request. To make a request, please contact us via
              datasubjectrights@bcg.com or call 1-866-I-OPT-OUT (1-866-467-8688)
              and enter service code 837# to leave us a message. We will verify
              and respond to your request consistent with applicable law, taking
              into account the type and sensitivity of the personal information
              subject to the request. We may need to request additional personal
              information from you, such as copy of your driver’s license,
              utility bill in order to verify your identity and protect against
              fraudulent requests. If you maintain a password-protected account
              with us, we may verify your identity through our existing
              authentication practices for your account and require you to
              re-authenticate yourself before disclosing or deleting your
              personal information. If you make a request to delete, we may ask
              you to confirm your request before we delete your personal
              information. To request to opt out of any future sharing of your
              personal information for purposes of cross-context behavioral
              advertising, click here. <br /><br />
              Authorized Agents <br />
              If an agent would like to make a request on your behalf as permitted by applicable law,
              the agent may use the submission methods noted in the section
              entitled “Individuaequests.” As part of our verification process,
              we may request that the agent provide, as applicable, proof
              concerning their status as an authorized agent. In addition, we
              may require that you verify your identity as described in the
              section entitled “Individual Requests” or confirm that you
              provided the agent permission to submit the request. <br /><br />
              FOOTNOTES [1]<br />
              Personal data only includes information relating to natural
              ...
              information for running background checks. [3] In our marketing
              communications with you we monitor and comply with applicable data
              privacy laws and if, at any time, you prefer not to receive
              further communications from us in any or all forms you will have
              the ability to unsubscribe from such communications by means of a
              link provided in every e-mail that is sent to you by us. When
              subscribing to Diamond Tofu e-mail newsletters, you are given the
              opportunity to select which promotions, news, and information you
              would like to receive at the time of sign up, and you will have
              the opportunity to unsubscribe from such communications. [4] Data
              transfers within Diamond Tofu entities are governed by Diamond
              Tofu’s intra company agreements, local data export restrictions
              and/or local data privacy laws. [5] CPRA defines sensitive
              personal information as personal information that reveals an
              individual’s social security, driver’s license, state
              ...
              allowing access to an account; precise geolocation; racial or
              ethnic origin, religious or philosophical beliefs, citizenship,
              immigration status, or union membership; the contents of mail,
              email, and text messages unless Diamond Tofu is the intended
              recipient of the communication; genetic data; The processing of
              biometric information for the purpose of uniquely identifying an
              individual; Personal information collected and analyzed concerning
              an individual’s health; and Personal information collected and
              analyzed concerning an individual’s sex life or sexual
              orientation.
            </p>
          </Modal.Body>
          <Modal.Footer>
